...
public:
  ...
  void fb_cms();
  void FillConversionTree(int selected_ele_index);
  ...
  FILE* outfile;
   ...
   UInt_t          NPFJets2;
   vector<float>   *PFJets2_energy;
   vector<float>   *PFJets2_et;
   vector<float>   *PFJets2_eta;
   vector<float>   *PFJets2_phi;
   vector<float>   *PFJets2_pt;
   vector<float>   *PFJets2_px;
   vector<float>   *PFJets2_py;
   vector<float>   *PFJets2_pz;
   vector<float>   *PFJets2_status;
   vector<float>   *PFJets2_theta;
   vector<float>   *PFJets2_chgEmE;
   vector<float>   *PFJets2_chgHadE;
   vector<float>   *PFJets2_chgMuE;
   vector<float>   *PFJets2_neutralEmE;
   vector<float>   *PFJets2_neutralHadE;
   vector<float>   *PFJets2_neutral_Mult;
   vector<float>   *PFJets2_mu_Mult;
   vector<float>   *PFJets2_mass;
   vector<float>   *PFJets2_id_hitsInN90;
   vector<float>   *PFJets2_emf;
   vector<float>   *PFJets2_id_fHPD;

   vector<float>   *PFJets2_numberOfDaughters;
   vector<float>   *PFJets2_CEF;
   vector<float>   *PFJets2_NHF;
   vector<float>   *PFJets2_NEF;
   vector<float>   *PFJets2_CHF;
   vector<float>   *PFJets2_chg_Mult;
  ...
  */
   ...
   TBranch        *b_NPFJets2;   //!
   TBranch        *b_PFJets2_energy;   //!
   TBranch        *b_PFJets2_et;   //!
   TBranch        *b_PFJets2_eta;   //!
   TBranch        *b_PFJets2_phi;   //!
   TBranch        *b_PFJets2_pt;   //!
   TBranch        *b_PFJets2_px;   //!
   TBranch        *b_PFJets2_py;   //!
   TBranch        *b_PFJets2_pz;   //!
   TBranch        *b_PFJets2_status;   //!
   TBranch        *b_PFJets2_theta;   //!
   TBranch        *b_PFJets2_chgEmE;   //!
   TBranch        *b_PFJets2_chgHadE;   //!
   TBranch        *b_PFJets2_chgMuE;   //!
   TBranch        *b_PFJets2_neutralEmE;   //!
   TBranch        *b_PFJets2_neutralHadE;   //!
   TBranch        *b_PFJets2_neutral_Mult;   //!
   TBranch        *b_PFJets2_mu_Mult;   //!
   TBranch        *b_PFJets2_mass;   //!
   TBranch        *b_PFJets2_id_hitsInN90;   //!
   TBranch        *b_PFJets2_id_fHPD;   //!
   TBranch        *b_PFJets2_emf;   //!
   TBranch        *b_PFJets2_numberOfDaughters;
   TBranch        *b_PFJets2_CEF;
   TBranch        *b_PFJets2_NHF;
   TBranch        *b_PFJets2_NEF;
   TBranch        *b_PFJets2_CHF;
   TBranch        *b_PFJets2_chg_Mult;   //!
  ...
  */
  ...
  Double_t        HLT_Photon20_Cleaned_L1R; //NEW

  Double_t  HLT_Ele10_LW_L1R;
  Double_t  HLT_Ele15_LW_L1R;
  Double_t  HLT_Ele15_SW_L1R;
  Double_t  HLT_Ele15_SW_CaloEleId_L1R;
  Double_t  HLT_Ele17_SW_CaloEleId_L1R;
  Double_t  HLT_Ele17_SW_TightEleId_L1R;
  Double_t  HLT_Ele22_SW_TighterEleId_L1R_v2;
  ...
  TBranch        *b_HLT_Photon20_Cleaned_L1R;   //NEW
  ...
  Bool_t         pass_photon10_TO20;
  TBranch        *b_pass_photon10_TO20;
  Bool_t         pass_photon15_TO20;
  TBranch        *b_pass_photon15_TO20;
  Bool_t         pass_photon15clean_TO20;
  TBranch        *b_pass_photon15clean_TO20;
  ...
  void    SetQCDEstimateForM3(float f) {m_QCD_estimateForM3 = f; };
...
private:
  ...
  void fillHisto_Njet_DataAndMC( v2D_TH1& h, const float& v ) const;
  ...
  bool   passEleID_VBTF_W95(const unsigned int&) const;
  bool   passHLT() const;
  ...
  bool  ConversionFinder2( int index_selected_ele);
  bool  ConversionFinder( int index_selected_ele, float this_dist, float this_dcot);
  bool  ConversionFinder2( int index_selected_ele, float this_dist, float this_dcot);
  ...
  */
  ...
  vector<TH1*> AN_1leadPFJet_pt;
  vector<TH1*> AN_2leadPFJet_pt;
  vector<TH1*> AN_3leadPFJet_pt;
  vector<TH1*> AN_4leadPFJet_pt;
  vector<TH1*> AN_1leadJet_pt;  
  vector<TH1*> AN_2leadJet_pt;  
  vector<TH1*> AN_3leadJet_pt;  
  vector<TH1*> AN_4leadJet_pt;  
  v2D_TH1 AN_met;
  v2D_TH1 AN_HT;
  v2D_TH1 AN_HTlep;
  v2D_TH1 AN_M3;
  v2D_TH1 AN_M3MaxPT;
  v2D_TH1 AN_mtw;
  v2D_TH1 AN_aes_reliso;
  v2D_TH1 AN_ElzPVz;
  v2D_TH1 AN_SigmaIetaIeta;
  v2D_TH1 AN_DelEta;
  v2D_TH1 AN_DelPhi;
  v2D_TH1 AN_HoE;
  v2D_TH1 AN_EE_SigmaIetaIeta;
  v2D_TH1 AN_EE_DelEta;
  v2D_TH1 AN_EE_DelPhi;
  v2D_TH1 AN_EE_HoE;
  //TH2D *ttbarMomentum;
  ...
  TH1D *h_hadTop_maxPT_mass_3j;   // 960 bins (0-960)     
  TH1D *h_hadTop_maxPT_pt_3j;
  TH1D *h_hadTop_maxPT_mass_nonIso_3j;
  TH1D *h_hadTop_maxPT_pt_nonIso_3j;
...
void ana::Init(){
   ...
   PFJets2_chgMuE = 0;
   PFJets2_chg_Mult = 0;
   PFJets2_neutralEmE = 0;
   PFJets2_neutralHadE = 0;
   PFJets2_neutral_Mult = 0;
   PFJets2_mu_Mult = 0;
   PFJets2_mass = 0;
   PFJets2_id_hitsInN90 = 0;
   PFJets2_id_fHPD = 0;
   PFJets2_emf = 0;
   PFMets_et = 0;
   PFMets_phi = 0;
   ...
   */
   ...
   if( m_jetAlgo=="pfjet" ){
     chain->SetBranchAddress("NPFJets2", &NPFJets2, &b_NPFJets2);
     chain->SetBranchAddress("PFJets2_energy", &PFJets2_energy, &b_PFJets2_energy);
     chain->SetBranchAddress("PFJets2_et", &PFJets2_et, &b_PFJets2_et);
     chain->SetBranchAddress("PFJets2_eta", &PFJets2_eta, &b_PFJets2_eta);
     chain->SetBranchAddress("PFJets2_phi", &PFJets2_phi, &b_PFJets2_phi);
     chain->SetBranchAddress("PFJets2_pt", &PFJets2_pt, &b_PFJets2_pt);
     chain->SetBranchAddress("PFJets2_px", &PFJets2_px, &b_PFJets2_px);
     chain->SetBranchAddress("PFJets2_py", &PFJets2_py, &b_PFJets2_py);
     chain->SetBranchAddress("PFJets2_pz", &PFJets2_pz, &b_PFJets2_pz);
     chain->SetBranchAddress("PFJets2_status", &PFJets2_status, &b_PFJets2_status);
     chain->SetBranchAddress("PFJets2_theta", &PFJets2_theta, &b_PFJets2_theta);
     chain->SetBranchAddress("PFJets2_chgEmE", &PFJets2_chgEmE, &b_PFJets2_chgEmE);
     chain->SetBranchAddress("PFJets2_chgHadE", &PFJets2_chgHadE, &b_PFJets2_chgHadE);
     chain->SetBranchAddress("PFJets2_chgMuE", &PFJets2_chgMuE, &b_PFJets2_chgMuE);
     chain->SetBranchAddress("PFJets2_neutralEmE", &PFJets2_neutralEmE, &b_PFJets2_neutralEmE);
     chain->SetBranchAddress("PFJets2_neutralHadE", &PFJets2_neutralHadE, &b_PFJets2_neutralHadE);
     chain->SetBranchAddress("PFJets2_neutral_Mult", &PFJets2_neutral_Mult, &b_PFJets2_neutral_Mult);
     chain->SetBranchAddress("PFJets2_mu_Mult", &PFJets2_mu_Mult, &b_PFJets2_mu_Mult);
     chain->SetBranchAddress("PFJets2_mass", &PFJets2_mass, &b_PFJets2_mass);
     chain->SetBranchAddress("PFJets2_id_hitsInN90", &PFJets2_id_hitsInN90, &b_PFJets2_id_hitsInN90);
     chain->SetBranchAddress("PFJets2_id_fHPD", &PFJets2_id_fHPD, &b_PFJets2_id_fHPD);
     chain->SetBranchAddress("PFJets2_emf", &PFJets2_emf, &b_PFJets2_emf);
     chain->SetBranchAddress("PFJets2_chg_Mult", &PFJets2_chg_Mult, &b_PFJets2_chg_Mult);
     chain->SetBranchAddress("PFJets2_numberOfDaughters", &PFJets2_numberOfDaughters, &b_PFJets2_numberOfDaughters);
     chain->SetBranchAddress("PFJets2_CEF", &PFJets2_CEF, &b_PFJets2_CEF);
     chain->SetBranchAddress("PFJets2_NHF", &PFJets2_NHF, &b_PFJets2_NHF);
     chain->SetBranchAddress("PFJets2_NEF", &PFJets2_NEF, &b_PFJets2_NEF);
     chain->SetBranchAddress("PFJets2_CHF", &PFJets2_CHF, &b_PFJets2_CHF);
   }
   ...
   chain->SetBranchAddress("jets_btag_ssvHE", &jets_btag_ssvHE, &b_jets_btag_ssvHE);
   ...
   */
   ...
   if(m_runOnV4ntuples){
     ...
     chain3->SetBranchAddress("pass_photon10_TO20", &pass_photon10_TO20, &b_pass_photon10_TO20);
     if(IsData()) {chain3->SetBranchAddress("pass_photon15_TO20", &pass_photon15_TO20, &b_pass_photon15_TO20);
       chain3->SetBranchAddress("pass_photon15clean_TO20", &pass_photon15clean_TO20, &b_pass_photon15clean_TO20);}
   }
   ...
   if( GetTrigger() ) {
     ...
     //if(HLTBit=="HLT_Photon20_Cleaned_L1R") {chain2->SetBranchAddress("HLT_Photon20_Cleaned_L1R", &HLT_Photon20_Cleaned_L1R, &b_HLT_Photon20_Cleaned_L1R);}

     //Since we use a variety of triggers for data, ignoring HLTbit requriement
     if(IsData()){
       chain2->SetBranchAddress("HLT_Ele10_LW_L1R",&HLT_Ele10_LW_L1R, &b_HLT_Ele10_LW_L1R);
       chain2->SetBranchAddress("HLT_Ele15_LW_L1R",&HLT_Ele15_LW_L1R, &b_HLT_Ele15_LW_L1R);
       chain2->SetBranchAddress("HLT_Ele15_SW_L1R",&HLT_Ele15_SW_L1R,&b_HLT_Ele15_SW_L1R);
       chain2->SetBranchAddress("HLT_Ele15_SW_CaloEleId_L1R",&HLT_Ele15_SW_CaloEleId_L1R,&b_HLT_Ele15_SW_CaloEleId_L1R);
       chain2->SetBranchAddress("HLT_Ele17_SW_CaloEleId_L1R",&HLT_Ele17_SW_CaloEleId_L1R,&b_HLT_Ele17_SW_CaloEleId_L1R);
       chain2->SetBranchAddress("HLT_Ele17_SW_TightEleId_L1R",&HLT_Ele17_SW_TightEleId_L1R,&b_HLT_Ele17_SW_TightEleId_L1R);
       chain2->SetBranchAddress("HLT_Ele22_SW_TighterEleId_L1R_v2",&HLT_Ele22_SW_TighterEleId_L1R_v2,&b_HLT_Ele22_SW_TighterEleId_L1R_v2);
     }
   }
