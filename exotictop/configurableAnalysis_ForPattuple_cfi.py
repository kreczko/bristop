...
TriggerPSets = cms.PSet(
    ...
    #trigger bits
        ...
        HLT_Ele15_LW_L1R  = cms.PSet(
            src = cms.InputTag("TriggerResults","","HLT8E29"),
            method = cms.string('HLTBitVariable')
            ),
        HLT_EM80  = cms.PSet(
            src = cms.InputTag("TriggerResults","","HLT"),
...
#These are added from 8E29 trigger menu
        HLT_Photon10_L1R = cms.PSet(
            src = cms.InputTag("TriggerResults","","HLT8E29"),
            method = cms.string('HLTBitVariable')
            ),
        HLT_Photon30_L1R_1E31 = cms.PSet(
            src = cms.InputTag("TriggerResults","","HLT"),
            method = cms.string('HLTBitVariable')
            ),
        ...
        HLT_Ele15_SW_LooseTrackIso_L1R = cms.PSet(
             src = cms.InputTag("TriggerResults","","HLT"),
             method = cms.string('HLTBitVariable')
             ),
        
        HLT_Ele15_SW_EleId_L1R = cms.PSet(
             src = cms.InputTag("TriggerResults","","HLT"),
             method = cms.string('HLTBitVariable')
             ),
        
        HLT_Ele20_SW_L1R = cms.PSet(
             src = cms.InputTag("TriggerResults","","HLT"),
             method = cms.string('HLTBitVariable')
             ),

        HLT_Ele20_SiStrip_L1R = cms.PSet(
             src = cms.InputTag("TriggerResults","","HLT"),
             method = cms.string('HLTBitVariable')
             ),
        
        HLT_Ele25_SW_L1R = cms.PSet(
             src = cms.InputTag("TriggerResults","","HLT"),
             method = cms.string('HLTBitVariable')
             ),
        
        HLT_Ele25_SW_EleId_LooseTrackIso_L1R = cms.PSet(
             src = cms.InputTag("TriggerResults","","HLT"),
             method = cms.string('HLTBitVariable')
             ),
        ...
        HLT_Ele15_SC15_SW_EleId_L1R = cms.PSet(
             src = cms.InputTag("TriggerResults","","HLT"),
             method = cms.string('HLTBitVariable')
             ),

        HLT_Ele15_SC15_SW_LooseTrackIso_L1R = cms.PSet(
             src = cms.InputTag("TriggerResults","","HLT"),
             method = cms.string('HLTBitVariable')
             ),

        HLT_Ele20_SC15_SW_L1R = cms.PSet(
             src = cms.InputTag("TriggerResults","","HLT"),
             method = cms.string('HLTBitVariable')
             )
...
#        mets = cms.InputTag("selectedLayer1METs"),
        ...
        #tcmets = cms.InputTag("tcMet"),
        tcmets = cms.InputTag("layer1METsTC"),
...
#        ccelectrons = cms.InputTag("patcrosscleaner","ccElectrons"),
        ...
        #pfJets = cms.InputTag("iterativeCone5PFJets"),
        #pfMets = cms.InputTag("pfMet"),
        pfJets = cms.InputTag("cleanLayer1JetsPFAK5"),
        pfMets = cms.InputTag("layer1METsPF"),
    #    genJets = cms.InputTag("iterativeCone5GenJetsNoNuBSM")
        genJets = cms.InputTag("sisCone5GenJets"),

        metsKT4 = cms.InputTag("layer1METsKT4"),
        metsSC5 = cms.InputTag("layer1METsSC5"),
        metsAK5 = cms.InputTag("layer1METsAK5"),
        
        jetsKT4 = cms.InputTag("cleanLayer1JetsKT4"),
        jetsKT6 = cms.InputTag("cleanLayer1JetsKT6"),
        jetsSC7 = cms.InputTag("cleanLayer1JetsSC7"),
        jetsSC5 = cms.InputTag("cleanLayer1JetsSC5"),
        jetsAK5 = cms.InputTag("cleanLayer1JetsAK5")
    ),
    Ntupler = cms.PSet(
...
#            ),
                ...
                mets = cms.PSet(
#                src = cms.InputTag("allLayer1METsIC5"),#changed to line below
            ...
            metsKT4 = cms.PSet(
            src = cms.InputTag("layer1METsKT4"),
            leaves = cms.PSet(
                vars = cms.vstring('et:et',
                                   'phi:phi',
                                   'ex:px',
            ...
            els = cms.PSet(
                ...
                leaves = cms.PSet(
                    ...
                    vars = cms.vstring(#'id:leptonID', 
                        ...
                        'isEcalDriven:isEcalDriven',
                        'isTrackerDriven:isTrackerDriven',
