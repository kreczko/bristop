...
#include "Tools/Event.hh"
#include "Tools/EventFilter.hh"
#include "Tools/Counter.hh"
#include <vector>
#include <iostream>
...
const string mcname[] = { "data", "ttbar", "ttjet", "wj", "zj", "enri1", "enri2", "enri3", "bce1", "bce2", "bce3",
		"vqq", "tW", "tchan", "schan", "Zprime_M500GeV_W5GeV", "Zprime_M500GeV_W50GeV", "Zprime_M750GeV_W7500MeV",
		"Zprime_M1TeV_W10GeV", "Zprime_M1TeV_W100GeV", "Zprime_M1250GeV_W12500MeV", "Zprime_M1500GeV_W15GeV",
		"Zprime_M1500GeV_W150GeV", "Zprime_M2TeV_W20GeV", "Zprime_M2TeV_W200GeV", "Zprime_M3TeV_W30GeV",
		"Zprime_M3TeV_W300GeV", "Zprime_M4TeV_W40GeV", "Zprime_M4TeV_W400GeV", "QCD", "singleTop" };

//TODO: remove them and put them in where the mcnames are filled
const string mcfiles[] = { "data", "ttbar", "ttjet", "wjet", "zjet", "enri1", "enri2", "enri3", "bce1", "bce2", "bce3",
		"vqq", "tW", "tchan", "schan", "Zprime_M500GeV_W5GeV", "Zprime_M500GeV_W50GeV", "Zprime_M750GeV_W7500MeV",
		"Zprime_M1TeV_W10GeV", "Zprime_M1TeV_W100GeV", "Zprime_M1250GeV_W12500MeV", "Zprime_M1500GeV_W15GeV",
		"Zprime_M1500GeV_W150GeV", "Zprime_M2TeV_W20GeV", "Zprime_M2TeV_W200GeV", "Zprime_M3TeV_W30GeV",
		"Zprime_M3TeV_W300GeV", "Zprime_M4TeV_W40GeV", "Zprime_M4TeV_W400GeV", "QCD", "singleTop" };

const string mclabel[] = { "data", "signal", "signalJ", "W+jets", "Z+jets", "enri1", "enri2", "enri3", "bce1", "bce2",
		"bce3", "VQQ", "tW", "t-chan", "s-chan", "Zprime_M500GeV_W5GeV", "Zprime_M500GeV_W50GeV",
		...
		"Zprime_M3TeV_W30GeV", "Zprime_M3TeV_W300GeV", "Zprime_M4TeV_W40GeV", "Zprime_M4TeV_W400GeV", "QCD",
		"singleTop" };
...
public:
	...
	enum EHist {
		...
		h_htsystem_matched,
		h_Chi2Leptonic,
		h_Chi2Leptonic_matched,
		h_Chi2Hadronic,
		h_Chi2Hadronic_matched,
		h_Chi2Global,
		h_Chi2Global_matched,
		h_Chi2Total,
		h_Chi2Total_matched,
		h_tlep_pt_matched,
		h_thad_pt_matched,
		...
		h_mass_diele,
		h_mass_diele_new,
		h_mass_diele_lowMet_1j,
		h_mass_ephoton_lowMet_1j,
		h_Nele_lowMet_1j,
		h_Nphoton_lowMet_1j,
		h_photon_eta_lowMet_1j,
		h_photon_et_lowMet_1j,
		h_photon1_eta_lowMet_1j,
		h_photon1_et_lowMet_1j,
		h_ed0_unCor,
		h_ed0,
		h_ed0_pass,
		h_muon_chi2,
		...
		h_btag_TC_highEff_b,
		h_btag_TC_highEff_c,
		h_btag_TC_highEff_uds,
		h_btag_TC_highEff_g,
		h_btag_TC_highPur_b,
		h_btag_TC_highPur_c,
		h_btag_TC_highPur_uds,
		h_btag_TC_highPur_g,
		h_btag_JetBProb_b,
		h_btag_JetBProb_c,
		h_btag_JetBProb_uds,
		...
		h_btag_JetProb_uds,
		h_btag_JetProb_g,
		h_btag_secondaryVertex_b,
		h_btag_secondaryVertex_c,
		h_btag_secondaryVertex_uds,
		h_btag_secondaryVertex_g,
		h_btag_softEle_b,
		h_btag_softEle_c,
		h_btag_softEle_uds,
		h_btag_softEle_g,
		...
		h_btag_softMuon_uds,
		h_btag_softMuon_g,
		h_btag_softMuonNoIP_b,
		h_btag_softMuonNoIP_c,
		h_btag_softMuonNoIP_uds,
		h_btag_softMuonNoIP_g,
		h_numberOfBtags,
		h_hadTop_maxPT_mass_4j,
		h_hadTop_maxPT_pt_4j,
		h_hadTop_maxPT_mass_nonIso_4j,
		h_hadTop_maxPT_pt_nonIso_4j,
		h_m3,
		h_m3_control,
		h_hadTop_maxPT_mass_4j_1000,
	...
	enum EJbinHist {
		...
		h_DPhiEmet_t1,
		h_QCDest_CombRelIso,
		h_QCDest_CombRelIso_AES,
		h_QCDest_CombRelIso_AES_minusMET,
		h_QCDest_CombRelIso_AES_minusHT,
		h_QCDest_CombRelIso_AES_minusTighterZ,
		h_QCDest_CombRelIso_AES_before,
		h_QCDest_CombRelIso_AES_justMET,
		h_QCDest_CombRelIso_AES_justHighMET,
		h_QCDest_CombRelIso_AES_justHT,
		h_QCDest_CombRelIso_AES_justZ,
		h_QCDest_CombRelIso_AES_planA1_e20,
		h_QCDest_CombRelIso_AES_planA1_e30,
		h_QCDest_CombRelIso_AES_planA2_e20,
		h_QCDest_CombRelIso_AES_planA2_e30,
		h_QCDest_CombRelIso_AES_planA3_e20,
		h_QCDest_CombRelIso_AES_planA3_e30,
		h_QCDest_CombRelIso_AES_planB1_e20,
		h_QCDest_CombRelIso_AES_planB1_e30,
		h_QCDest_CombRelIso_AES_planB2_e20,
		h_QCDest_CombRelIso_AES_planB2_e30,
		h_QCDest_CombRelIso_AES_planB3_e20,
		h_QCDest_CombRelIso_AES_planB3_e30,
		h_QCDest_CombRelIso_AES_planB3b_e20,
		h_QCDest_CombRelIso_AES_planB3b_e30,
		h_QCDest_CombRelIso_AES_planB4_e20,
		h_QCDest_CombRelIso_AES_planB4_e30,
		h_QCDest_CombRelIso_AES_planB5_e20,
		h_QCDest_CombRelIso_AES_planB5_e30,
		h_QCDest_CombRelIso_AES_planB6_e20,
		h_QCDest_CombRelIso_AES_planB6_e30,
		h_QCDest_CombRelIso_AES_planB7_e20,
		h_QCDest_CombRelIso_AES_planB7_e30,
		h_QCDest_CombRelIso_AES_planB8_e20,
		h_QCDest_CombRelIso_AES_planB8_e30,
		NUMBER_OF_JETBINNED_HISTOGRAMS
	};

	enum ENlevelJbinned2DHists {
		h_QCDest_isoVmet_NES,
		h_QCDest_isoVmet_NES_barrel,
		h_QCDest_isoVmet_NES_endcap,
		h_QCDest_isoVmet_NES_uw,
		h_QCDest_isoVmet_NES_uw_barrel,
		h_QCDest_isoVmet_NES_uw_endcap,
		NUMBER_OF_NLEVEL_JBINNED_2D_HISTOGRAMS
	};

	enum ENlevelJbinned1DHists {
		h_QCDest_CombRelIso_NES,
		h_QCDest_CombRelIso_NES_barrel,
		h_QCDest_CombRelIso_NES_endcap,
		h_QCDest_CombRelIso_NES_loMET,
		h_QCDest_CombRelIso_NES_loMET_barrel,
		h_QCDest_CombRelIso_NES_loMET_endcap,
		h_QCDest_CombRelIso_NES_hiMET,
		h_QCDest_CombRelIso_NES_hiMET_barrel,
		h_QCDest_CombRelIso_NES_hiMET_endcap,
		NUMBER_OF_NLEVEL_JBINNED_1D_HISTOGRAMS
	};
	 ...
	 */
	enum E2DHist {
		h_ptRel_vs_deltaRmin,
		h_mWhad_vs_mthad,
		h_mWhad_vs_mthad_btag_fake,
		k2D_mWlep_vs_mtlep,
		k2D_mWlep_vs_mtlep_btag_fake,
		h_exp_met_v_eeta,
		h_Zee_photon_eteta_2D,
		h_ptratio_vs_mttbar,
		h_htsystem_vs_mttbar,
		h_pttbar_vs_mttbar,
		h_angle_b_e_vs_mttbar,
		NUMBER_OF_2D_HISTOGRAMS
	};
...
private:
	...
	void
	fillHistoDataAndMC(ushort hist, const float value, const double weight);
	...
	void iso_fillHisto_nlevel_nj_nmc(const ushort hist, ushort level, const float valueX, const float valueY,
			const float weight);
	...
	short
	findClosest(const std::vector<TLorentzVector>&, const TLorentzVector&);
	...
	void
	PrintErrorTables(const double e_plus_jet[][5][nmctype], const double e_plus_jet_weighted[][5][nmctype], vector<
			string> ve) const;
	...
	void
	valid_fillHisto(TH1F* h[][7], const bool cuts[8], int nj, double value) const;
