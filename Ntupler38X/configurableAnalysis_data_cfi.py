...
ele_vars = cms.vstring(
    ...
    'fbrem:fbrem',
    'dB:dB',    #d0 w.r.t beam spot/PV (PAT). Default is PV (17-08-10).
...
#             ),
    ...
    InputTags = cms.PSet(
        ...
        ###metsKT4 = cms.InputTag("patMETsKT4Calo"),#removed for v5
        ###metsKT6 = cms.InputTag("patMETsKT6Calo"),#removed for v5
        tcmets  = cms.InputTag("patMETsTC"),        
        #pfMets = cms.InputTag("patMETsPF"),       

        ###jetsKT4    = cms.InputTag("cleanPatJetsKT4Calo"),#removed for v5
        ###jetsKT6    = cms.InputTag("cleanPatJetsKT6Calo"),#removed for v5
        #jetsAK5JPT = cms.InputTag("cleanPatJetsAK5JPT"), #jet-plus-tracks
        jetsAK5JPT = cms.InputTag("patJetsAK5JPT"), #jet-plus-tracks #removed for v5
    ...
    Ntupler = cms.PSet(
        branchesPSet = cms.PSet(
           ...
           src = cms.string('beamspot'),
            ...
            ## TL added 18 May
            ## note, 270910: hcalNoise not in AOD, so comment out to remove warnings
...
#            ),
           ...
           #####
            ...
            leaves = cms.PSet(
                vars = cms.vstring('px', 'py',
                                   'd0_bs:dB',#default is PV, but we've set usePV to false for els3
                                   'ed0_bs:edB')
                ),
            Class = cms.string('pat::Electron')                
            ),
