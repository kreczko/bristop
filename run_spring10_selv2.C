...
//==================================================================
{
	...
	myana->SetInputFile("/storage/top/mc/spring10_7TeV_new/MG/HLTskim_wjet/*.root");
	...
	myana->SetInputFile("/storage/top/mc/spring10_7TeV_new/pythia/HLTskim_enri3/*.root");//NEW
	...
	myana->SetInputFile("/storage/top/mc/spring10_7TeV_new/pythia/HLTskim_bce3/*.root");//NEW
