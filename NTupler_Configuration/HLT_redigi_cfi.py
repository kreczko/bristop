...
TriggerPSets = cms.PSet(
      ...
      HLTriggerFirstPath = cms.PSet(
         src = cms.InputTag("TriggerResults","","REDIGI"),
      ...
      HLT_L1SingleEG1 = cms.PSet(
         src = cms.InputTag("TriggerResults","","REDIGI"),
         method = cms.string('HLTBitVariable')

      ),

      HLT_L1SingleEG1_NoBPTX = cms.PSet(
         src = cms.InputTag("TriggerResults","","REDIGI"),
         method = cms.string('HLTBitVariable')
      ...
      HLT_HFThreshold3 = cms.PSet(
         src = cms.InputTag("TriggerResults","","REDIGI"),
         method = cms.string('HLTBitVariable')

      ),

      HLT_HFThreshold10 = cms.PSet(
         src = cms.InputTag("TriggerResults","","REDIGI"),
         method = cms.string('HLTBitVariable')
