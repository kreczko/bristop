...
jet_commonVarList = cms.vstring(    
    ...
    'CHF:chargedHadronEnergyFraction', ## TL 16 Apr
    'NHF:neutralHadronEnergyFraction', ## TL 16 Apr
    'CEF:chargedEmEnergyFraction',     ## TL 16 Apr
    'NEF:neutralEmEnergyFraction'      ## TL 16 Apr
    )
...
#             ),
    ...
    InputTags = cms.PSet(
        ...
        pfElectrons = cms.InputTag("selectedPatElectronsPF"),
...
#            ),
            ...
            # New addition (TL) 21-1-10
            conversions = cms.PSet(
            src = cms.string('conversions'),
            leaves = cms.PSet(
                vars = cms.vstring('pairInvMass:pairInvariantMass',
                                   'pairCotThetaSeparation',#same name
                                   'dEtaTracksAtEcal',
                                   'dPhiTracksAtEcal',
                                   'dPhiTracksAtVtx',
                                   ...
                                   'pt:pairMomentum.perp',##simplified name
                                   'eta:pairMomentum.eta'
                                   )
                ),
            Class = cms.string("reco::Conversion")
            ),

            ## TL (27-1-10)
            Kshort = cms.PSet(
            src = cms.string("Kshort"),
            leaves = cms.PSet(
                basicKinematicLeaves,
                vars = cms.vstring('mass',
                                   'vertexChi2',
                                   'vertexNdof')
                ),
            Class = cms.string("reco::VertexCompositeCandidate")
            ),
            
            ## TL (27-1-10)
            Lambda = cms.PSet(
            src = cms.string("Lambda"),
            leaves = cms.PSet(
                basicKinematicLeaves,
                vars = cms.vstring('mass',
                                   'vertexChi2',
